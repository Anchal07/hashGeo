...
public class BoundingBox implements Serializable {
	 ...
	 */
	public BoundingBox(ch.hsr.geohash.WGS84Point southWestCorner, ch.hsr.geohash.WGS84Point northEastCorner) {
	 ...
	 * @return
	 */
	public ch.hsr.geohash.WGS84Point getNorthWestCorner() {
		return new ch.hsr.geohash.WGS84Point(northLatitude, westLongitude);
	}
	 ...
	 * @return
	 */
	public ch.hsr.geohash.WGS84Point getNorthEastCorner() {
		return new ch.hsr.geohash.WGS84Point(northLatitude, eastLongitude);
	}
	 ...
	 * @return
	 */
	public ch.hsr.geohash.WGS84Point getSouthEastCorner() {
		return new ch.hsr.geohash.WGS84Point(southLatitude, eastLongitude);
	}
	 ...
	 * @return
	 */
	public ch.hsr.geohash.WGS84Point getSouthWestCorner() {
		return new ch.hsr.geohash.WGS84Point(southLatitude, westLongitude);
	}
	...
	public boolean contains(ch.hsr.geohash.WGS84Point point) {
	...
	public ch.hsr.geohash.WGS84Point getCenter() {
